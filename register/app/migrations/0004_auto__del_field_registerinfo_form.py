...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RegisterInfo.form'
        db.delete_column(u'app_registerinfo', 'form_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RegisterInfo.form'
        raise RuntimeError("Cannot reverse this migration. 'RegisterInfo.form' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RegisterInfo.form'
        db.add_column(u'app_registerinfo', 'form',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Registration']),
                      keep_default=False)
