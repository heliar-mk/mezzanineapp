...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registration.response'
        db.add_column(u'app_registration', 'response',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registration.response'
        db.delete_column(u'app_registration', 'response')
