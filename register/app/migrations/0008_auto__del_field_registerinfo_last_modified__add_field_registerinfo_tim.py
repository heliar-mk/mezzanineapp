...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisterInfo.timestamp'
        db.add_column(u'app_registerinfo', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RegisterInfo.last_modified'
        raise RuntimeError("Cannot reverse this migration. 'RegisterInfo.last_modified' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RegisterInfo.last_modified'
        db.add_column(u'app_registerinfo', 'last_modified',
                      self.gf('django.db.models.fields.TimeField')(auto_now=True, blank=True),
                      keep_default=False)
