...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegisterInfo.jobtime'
        db.alter_column(u'app_registerinfo', 'jobtime', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'RegisterInfo.phone'
        db.alter_column(u'app_registerinfo', 'phone', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'RegisterInfo.date'
        db.alter_column(u'app_registerinfo', 'date', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'RegisterInfo.jobtime'
        db.alter_column(u'app_registerinfo', 'jobtime', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'RegisterInfo.phone'
        db.alter_column(u'app_registerinfo', 'phone', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'RegisterInfo.date'
        db.alter_column(u'app_registerinfo', 'date', self.gf('django.db.models.fields.IntegerField')())
